            ...
            <div className="row row-cols-1">
              <div className="col">
                <div className="breadcrumb__content">
                  <h1 className="breadcrumb__content--title text-white mb-10">Shop Right</h1>
                  <ul className="breadcrumb__content--menu d-flex">
                    <li className="breadcrumb__content--menu__items"><Link className="text-white" to="/">Home</Link></li>
                    <li className="breadcrumb__content--menu__items"><span className="text-white">Shop Right Sidebar</span></li>
                  </ul>
                </div>
              </div>
            </div>
                    ...
                    <div id="product_grid" className="tab_pane active show">
                      <div className="product__section--inner product__grid--inner">
                        <div className="row row-cols-xxl-4 row-cols-xl-3 row-cols-lg-3 row-cols-md-3 row-cols-2 mb--n30">
                            ...
                            <div className="product__items ">
                              <div className="product__items--thumbnail">
                                ...
                                <ul className="product__items--action d-flex justify-content-center">
                                  ...
                                  {/* <li class="product__items--action__list">
                                                                <Link class="product__items--action__btn" to="compare.html">
                              ...
                              <div className="product__items--content text-center">
                                {/* <div class="product__items--color">
                                            ...
                                            <li class="product__items--color__list"><Link class="product__items--color__link one" to="/shop"><span class="visually-hidden">Color 1</span></Link></li>
                                            <li class="product__items--color__list"><Link class="product__items--color__link two" to="/shop"><span class="visually-hidden">Color 2</span></Link></li>
                                            <li class="product__items--color__list"><Link class="product__items--color__link three" to="/shop"><span class="visually-hidden">Color 3</span></Link></li>
                                            <li class="product__items--color__list"><Link class="product__items--color__link four" to="/shop"><span class="visually-hidden">Color 4</span></Link></li>
                                        </ul>
                                                        </div> */}
                          ...
                          {/* <div class="col mb-30">
                                                <div class="product__items ">
                                                    <div class="product__items--thumbnail">
                                                        <Link class="product__items--link" to="/product">
                                                        ...
                                                        <ul class="product__items--action d-flex justify-content-center">
                                                            <li class="product__items--action__list">
                                                                <Link class="product__items--action__btn" data-open="modal1" to="/shop">
                                                            ...
                                                            <li class="product__items--action__list">
                                                                <Link class="product__items--action__btn" to="/wishlist">
                          ...
                          {/* <h3 class="product__items--content__title h4"><Link to="/product">Globe Electric Lamp</Link></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">₹145.00</span>
                                                            <span class="old__price">₹185.00</span>
                                                        </div>
                                                        <Link class="product__items--action__cart--btn primary__btn" to="/cart">
                          ...
                          {/* <h3 class="product__items--content__title h4"><Link to="/product">Fashion Plastic Chair</Link></h3>
                                                        <div class="product__items--price">
                          ...
                          {/* <h3 class="product__items--content__title h4"><Link to="/product">Design Rooms Sofa</Link></h3>
                                                        <div class="product__items--price">
                          ...
                          {/* <h3 class="product__items--content__title h4"><Link to="/product">Modern Swivel Chair</Link></h3>
                                                        <div class="product__items--price">
                          ...
                          {/* <h3 class="product__items--content__title h4"><Link to="/product">Design Living Sofa</Link></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price">₹155.00</span>
                          ...
                          {/* <h3 class="product__items--content__title h4"><Link to="/product">Plastic Chair Wooden</Link></h3>
                                                        <div class="product__items--price">
                          ...
                          {/* <h3 class="product__items--content__title h4"><Link to="/product">Folding Tables Chairs</Link></h3>
                                                        <div class="product__items--price">
                          ...
                          <div className="col mb-30 d-xl-none d-xxl-block">
                            <div className="product__items ">
                              <div className="product__items--thumbnail">
                                ...
                                {/* <h3 class="product__items--content__title h4"><Link to="/product">Modern Fabric Chair</Link></h3>
                                                        <div class="product__items--price">
                              ...
                              <div className="product__list--items__right">
                                ...
                                <div className="product__list--action">
                                  ...
                                  <ul className="product__list--action__wrapper d-flex align-items-center">
                                    ...
                                    <li className="product__list--action__child">
                                      <Link className="product__list--action__btn" to="/wishlist">
...
<option value="4">Sort by  rating </option>
                    ...
                    <ul className="widget__categories--menu">
                      <li className="widget__categories--menu__list">
                        <label className="widget__categories--menu__label d-flex align-items-center">
                          ...
                          <span className="widget__categories--menu__text"><Link to="/shop">Fashion Plastic Chair</Link></span>
                      ...
                      <li className="widget__categories--menu__list">
                        <label className="widget__categories--menu__label d-flex align-items-center">
                          ...
                          <span className="widget__categories--menu__text"><Link to="/product">Modern Swivel Chair</Link></span>
                          {/* <svg className="widget__categories--menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394">
                            <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor" />
                          </svg> */}
                        </label>
                        <ul className="widget__categories--sub__menu">
                          {/* <li className="widget__categories--sub__menu--list">
                            <Link className="widget__categories--sub__menu--link d-flex align-items-center" to="/cart">
                              <img className="widget__categories--sub__menu--img" src="assets/img/product/small-product2.webp" alt="categories-img" />
                              <span className="widget__categories--sub__menu--text">Wakefit Office Chair</span>
                            </Link>
                          </li> */}
                          {/* <li className="widget__categories--sub__menu--list">
                            <Link className="widget__categories--sub__menu--link d-flex align-items-center" to="/cart">
                              <img className="widget__categories--sub__menu--img" src="assets/img/product/small-product3.webp" alt="categories-img" />
                              <span className="widget__categories--sub__menu--text">Gaming Office Desk Chair.</span>
                            </Link>
                          </li> */}
                          {/* <li className="widget__categories--sub__menu--list">
                            <Link className="widget__categories--sub__menu--link d-flex align-items-center" to="/cart">
                              <img className="widget__categories--sub__menu--img" src="assets/img/product/small-product4.webp" alt="categories-img" />
                              <span className="widget__categories--sub__menu--text">Venture Premium Chair.</span>
                            </Link>
                          </li>
                          <li className="widget__categories--sub__menu--list">
                            <Link className="widget__categories--sub__menu--link d-flex align-items-center" to="/cart">
                              <img className="widget__categories--sub__menu--img" src="assets/img/product/small-product5.webp" alt="categories-img" />
                              <span className="widget__categories--sub__menu--text">Amaze Project Arm Chair.</span>
                            </Link>
                          </li> */}
                        </ul>
                      </li>
                      <li className="widget__categories--menu__list">
                        <label className="widget__categories--menu__label d-flex align-items-center">
                          ...
                          <span className="widget__categories--menu__text"><Link to="/topnewf">Folding Tables Chairs</Link></span>
                          {/* <svg className="widget__categories--menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394">
                            <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor" />
                          </svg> */}
                        </label>
                        <ul className="widget__categories--sub__menu">
                          <li className="widget__categories--sub__menu--list">
                            <Link className="widget__categories--sub__menu--link d-flex align-items-center" to="/cart">
                              <img className="widget__categories--sub__menu--img" src="assets/img/product/small-product2.webp" alt="categories-img" />
                              <span className="widget__categories--sub__menu--text">Design Living Sofa</span>
                            </Link>
                          </li>
                          <li className="widget__categories--sub__menu--list">
                            <Link className="widget__categories--sub__menu--link d-flex align-items-center" to="/cart">
                              <img className="widget__categories--sub__menu--img" src="assets/img/product/small-product3.webp" alt="categories-img" />
                              <span className="widget__categories--sub__menu--text">Fashion Plastic Chair</span>
                            </Link>
                          </li>
                          <li className="widget__categories--sub__menu--list">
                            <Link className="widget__categories--sub__menu--link d-flex align-items-center" to="/cart">
                              <img className="widget__categories--sub__menu--img" src="assets/img/product/small-product4.webp" alt="categories-img" />
                              <span className="widget__categories--sub__menu--text">Modern Swivel Chair</span>
                            </Link>
                          </li>
                          {/* <li className="widget__categories--sub__menu--list">
                            <Link className="widget__categories--sub__menu--link d-flex align-items-center" to="/cart">
                              <img className="widget__categories--sub__menu--img" src="assets/img/product/small-product5.webp" alt="categories-img" />
                              <span className="widget__categories--sub__menu--text"><Link to="/shop">Plastic Chair Wooden</Link></span>
                            </Link>
                          </li> */}
                        </ul>
                      </li>
                      <li className="widget__categories--menu__list">
                        <label className="widget__categories--menu__label d-flex align-items-center">
                          ...
                          <span className="widget__categories--menu__text"><Link to="/product">Plastic Chair Wooden</Link></span>
                          {/* <svg className="widget__categories--menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394">
                            <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor" />
                          </svg> */}
                        </label>
                        <ul className="widget__categories--sub__menu">
                          {/* <li className="widget__categories--sub__menu--list">
                            <Link className="widget__categories--sub__menu--link d-flex align-items-center" to="/cart">
                              <img className="widget__categories--sub__menu--img" src="assets/img/product/small-product2.webp" alt="categories-img" />
                              <span className="widget__categories--sub__menu--text">Modern Fabric Chair</span>
                            </Link>
                          </li>
                          <li className="widget__categories--sub__menu--list">
                            <Link className="widget__categories--sub__menu--link d-flex align-items-center" to="/cart">
                              <img className="widget__categories--sub__menu--img" src="assets/img/product/small-product3.webp" alt="categories-img" />
                              <span className="widget__categories--sub__menu--text">Folding Tables Chairs</span>
                            </Link>
                          </li> */}
                          {/* <li className="widget__categories--sub__menu--list">
                            <Link className="widget__categories--sub__menu--link d-flex align-items-center" to="/cart">
                              <img className="widget__categories--sub__menu--img" src="assets/img/product/small-product4.webp" alt="categories-img" />
                              <span className="widget__categories--sub__menu--text">Plastic Chair Wooden</span>
                            </Link>
                          </li> */}
                          {/* <li className="widget__categories--sub__menu--list">
                            <Link className="widget__categories--sub__menu--link d-flex align-items-center" to="/cart">
                              <img className="widget__categories--sub__menu--img" src="assets/img/product/small-product5.webp" alt="categories-img" />
                              <span className="widget__categories--sub__menu--text"><Link to="/shop">Design Living Sofa</Link></span>
                            </Link>
                          </li> */}
                        </ul>
                      </li>
                      <li className="widget__categories--menu__list">
                        <label className="widget__categories--menu__label d-flex align-items-center">
                          ...
                          <span className="widget__categories--menu__text"><Link to="/shop">Design Living Sofa</Link></span>
                          {/* <svg className="widget__categories--menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394">
                            <path d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor" />
                          </svg> */}
                        </label>
                  ...
                  </div>                  <div className="single__widget price__filter widget__bg">
                                ...
                                <div class="product__grid--inner">
                                    <div class="product__items product__items--grid d-flex align-items-center">
                                        ...
                                        <div class="product__items--grid__content">
                                            <h3 class="product__items--content__title h4"><Link to="/product">Modern Chair</Link></h3>
                                            <div class="product__items--price">
                                                <span class="current__price">₹165.00</span>
                                            </div>
                                            <div class="product__items--color">
                                    ...
                                    <div class="product__items product__items--grid d-flex align-items-center">
                                        ...
                                        <div class="product__items--grid__content">
                                            <h3 class="product__items--content__title h4"><Link to="/product">Plastic Chair</Link></h3>
                                            <div class="product__items--price">
                                                <span class="current__price">₹165.00</span>
                                            </div>
                                            <div class="product__items--color">
                                    ...
                                    <div class="product__items product__items--grid d-flex align-items-center">
                                        ...
                                        <div class="product__items--grid__content">
                                            <h3 class="product__items--content__title h4"><Link to="/product">Design Rooms</Link></h3>
                                            <div class="product__items--price">
                                                <span class="current__price">₹165.00</span>
                                            </div>
                                            <div class="product__items--color">
                  ...
                  {/* <div class="single__widget widget__bg">
                                ...
                                <ul class="widget__tagcloud">
                                    <li class="widget__tagcloud--list"><Link class="widget__tagcloud--link" to="/shop">Wooden</Link></li>
                                    <li class="widget__tagcloud--list"><Link class="widget__tagcloud--link" to="/shop">Chair</Link></li>
                                    <li class="widget__tagcloud--list"><Link class="widget__tagcloud--link" to="/shop">Modern</Link></li>
                                    <li class="widget__tagcloud--list"><Link class="widget__tagcloud--link" to="/shop">Fabric  </Link></li>
                                    <li class="widget__tagcloud--list"><Link class="widget__tagcloud--link" to="/shop">Shoulder </Link></li>
                                    <li class="widget__tagcloud--list"><Link class="widget__tagcloud--link" to="/shop">Winter</Link></li>
                                    <li class="widget__tagcloud--list"><Link class="widget__tagcloud--link" to="/shop">Accessories</Link></li>
                                    <li class="widget__tagcloud--list"><Link class="widget__tagcloud--link" to="/shop">Dress </Link></li>
                                </ul>
                            </div> */}
                </div>
              </div>
