...
function Contact() {
  ...
  const getHomeData = async () => {
    ...
    await axios
      .get("http://admin.rentifi.in:3023/website/contact_us_list", data, options)
      .then((res) => {
        ...
        <div class="container">
          <div class="section__heading mb-40">
            ...
            <p class="contact__section--hrading__desc">
              ...
              voluptatibus delectus blanditiis rerum, explicabo <br />{" "}
              aspernatur magni nihil distinctio voluptatum quo sit quidem minima
              repellat sapiente.
            </p>
          </div>
                        ...
                        <div class="contact__info--items__inner d-flex">
                          ...
                          <div class="contact__info--content">
                            <p class="contact__info--content__desc text-white">
                              ...
                              <a href="tel:+01234-567890">{list.whatsapp}</a>
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="contact__info--items__inner d-flex">
                        <div className="contact__info--icon">
                          ...
                          <img
                            ...
                            src="assets/img/logo/download2.jpg"
                          />
                        </div>
