                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer__widget">
                            ...
                            <div class="footer__widget--inner">
                                <Link class="footer__logo" to="/home"><img src="assets/img/logo/nav-log.webp" alt="footer-logo"/></Link>
                                <p class="footer__widget--desc">Ut enim ad minim veniam, quis <> nostrud exercitation ullamco laboris </> nisi ut aliquip ex ea commodo.</p>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer__widget">
                            ...
                            <ul class="footer__widget--menu footer__widget--inner">
                                <li class="footer__widget--menu__list"><Link class="footer__widget--menu__text" to="/myaccount">My Account</Link></li>
                                ...
                                <li class="footer__widget--menu__list"><Link class="footer__widget--menu__text" to="/login">Register</Link></li>
                                <li class="footer__widget--menu__list"><Link class="footer__widget--menu__text" to="/checkout">Checkout</Link></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
